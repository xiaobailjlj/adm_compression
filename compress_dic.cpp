...
// void compress_dic_impl_int8(const std::string& inputFilePath, const std::string& outputFilePath, const std::string& dicFilePath) {
//     std::ifstream inputFile(inputFilePath);
//     std::ofstream outputFile(outputFilePath, std::ios::binary);
//     std::ofstream dicFile(dicFilePath);
...
//     dicFile << index << "\n";
//     // std::cout << "dicValues size " << dicValues.size() << "\n" << std::endl;
//     // std::cout << "dicValues size " << dicValues[0]<< "\n" << std::endl;
//     for (int i = 0; i < dicValues.size(); i++) {
//         // std::cout << "dicValues: " << static_cast<int>(dicValues[i]) << "\n" << std::endl;
//         // dicFile << std::to_string(dicValues[i]) << "\n";
...
//     outputFile << valueCount << "\n";

//     for (const int& val : values) {
//         // uint32_t index = dictionary[val];

//         // std::string valStr = std::to_string(dictionary[val]);
//         // std::cout << "valStr: " << valStr.length() << valStr << "\n" << std::endl;
//         // outputFile << valStr << "\n";
//         outputFile << dictionary[val] << "\n";
//     }
...
// void compress_dic_impl_common(const std::string& inputFilePath, const std::string& outputFilePath, const std::string& dicFilePath) {
//     std::ifstream inputFile(inputFilePath);
//     std::ofstream outputFile(outputFilePath, std::ios::binary);
//     std::ofstream dicFile(dicFilePath);
//     if (!inputFile.is_open()) {
...
//     for (int i = 0; i < dicValues.size(); i++) {
//         // std::cout << "dictionary: " << dicValues[i] << "\n" << std::endl;
//         dicFile << dicValues[i] << "\n";
//     }
